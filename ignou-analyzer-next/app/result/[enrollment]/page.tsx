            ...
            <div className="w-full max-w-6xl bg-white rounded-2xl p-8 border shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8">
                    ...
                    <div className="relative p-4 border rounded-xl bg-white shadow-sm">
                        ...
                        <p className="text-lg font-bold text-[#0f172a]">{data?.student?.enrollment}</p>
                    </div>
                    ...
                    <div className="relative p-4 border rounded-xl bg-white shadow-sm">
                        ...
                        <p className="text-sm font-semibold text-[#0f172a]">
                            {data?.subjectDetails?.total_subject} / {data?.subjectDetails?.total_subject}
                        </p>
                        ...
                        <div className="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div
                                ...
                                style={{
                                    width: `${(data?.subjectDetails?.total_subject / data?.subjectDetails?.total_subject) * 100}%`
                                }}
                            />
                        </div>
                    </div>
                                    ...
                                    {data?.grades?.map((subject: any, index: number) => (
                                        <tr key={index} className="border-t hover:bg-gray-50">
                                            ...
                                            <td className="p-3 text-center">
                                                <span
                                                    className={`px-3 py-1 rounded-full text-xs font-semibold ${subject.Status === "COMPLETED"
